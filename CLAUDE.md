...
Mahantesh Mallappa Ambi — AI Engineering Manager, currently based in **Malaysia (UTC+8)**.
...
**Ambi Portfolio sheet ID:** `1VxjJti09_qU0yaE24CmjSab1j03tIobkFFDSmzn7dkE`
Contains: FD, MF (Coin), Stocks (Kite), Savings, PPF, PF, US Stocks (Vested), Shilpa's holdings.
